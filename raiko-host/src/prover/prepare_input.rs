...
pub enum AnchorError {
    ...
    AnchorValueMisMatch {expected: EthersU256, got: EthersU256},

    #[error("anchor transaction gas limit mismatch, expected: {expected}, got: {got:?}")]
    AnchorGasLimitMisMatch {expected: EthersU256, got: EthersU256},

    #[error("anchor transaction fee cap mismatch, expected: {expected:?}, got: {got:?}")]
    AnchorFeeCapMisMatch {expected: Option<EthersU256>, got: Option<EthersU256>},
