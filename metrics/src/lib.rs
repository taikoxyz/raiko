...
lazy_static! {
    ...
    .unwrap();
    pub static ref ACTOR_ACTION_RX_LENGTH_GAUGE: Gauge = register_gauge!(
        "raiko_actor_action_rx_length",
        "raiko_actor_action_rx_length",
    )
    .unwrap();
    pub static ref ACTOR_HIGH_PRIORITY_ACTION_RX_LENGTH_GAUGE: Gauge = register_gauge!(
        "raiko_actor_high_priority_action_rx_length",
        "raiko_actor_high_priority_action_rx_length",
    )
    .unwrap();
    pub static ref ACTOR_INTERNAL_RX_LENGTH_GAUGE: Gauge = register_gauge!(
        "raiko_actor_internal_rx_length",
        "raiko_actor_internal_rx_length",
    )
    .unwrap();
    pub static ref ACTOR_HIGH_PRIORITY_INTERNAL_RX_LENGTH_GAUGE: Gauge = register_gauge!(
        "raiko_actor_high_priority_internal_rx_length",
        "raiko_actor_high_priority_internal_rx_length",
    )
    .unwrap();
}
...
pub fn set_actor_action_rx_length(length: usize) {
    ACTOR_ACTION_RX_LENGTH_GAUGE.set(length as f64);
}

pub fn set_actor_high_priority_action_rx_length(length: usize) {
    ACTOR_HIGH_PRIORITY_ACTION_RX_LENGTH_GAUGE.set(length as f64);
}

pub fn set_actor_internal_rx_length(length: usize) {
    ACTOR_INTERNAL_RX_LENGTH_GAUGE.set(length as f64);
}

pub fn set_actor_high_priority_internal_rx_length(length: usize) {
    ACTOR_HIGH_PRIORITY_INTERNAL_RX_LENGTH_GAUGE.set(length as f64);
}
