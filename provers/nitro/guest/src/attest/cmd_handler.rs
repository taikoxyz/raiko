...
use crate::{app_args::*, attest::signature::*};
...
pub fn bootstrap(global_opts: GlobalOpts) -> Result<String> {
...
pub fn one_shot(global_opts: GlobalOpts, args: OneShotArgs, input: GuestInput) -> Result<String> {
