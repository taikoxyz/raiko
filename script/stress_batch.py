            ...
            try:
                ...
                if result is not None:
                    ...
                    for batch_id in batch_ids:
                        self.logger.info(f"New batch detected: {batch_id}@{current_block}")
...
# python stress_batch.py -t native -g 8950,8960 -p 3 -o stress_dev.log -c '0xbE71D121291517c85Ab4d3ac65d70F6b1FD57118'
