...
Before running you should set the rust toolchain in workspace to the desired prover's toolchain. If the script is not run, cargo will proceed with the default `rust-toolchain` file which specifies "nightly". Assuming you want to run prover X:
